...
function webzine_js_alter(&$javascript)
{
  ...
  $javascript['misc/jquery.js']['data'] = '//fastly.jsdelivr.net/npm/jquery@3.5.0/dist/jquery.min.js';
}
...
function webzine_preprocess_page(&$variables) {
  ...
  drupal_add_js('//fastly.jsdelivr.net/npm/jquery-validation@1.19.0/dist/jquery.validate.min.js', array('type' => 'external', 'scope' => 'header', 'group' => JS_LIBRARY ));
  ...
  drupal_add_css('//fastly.jsdelivr.net/npm/xeicon@2.3.3/xeicon.min.css', array('type' => 'external', 'group' => CSS_THEME));
