...
<?php else: ?>
    ...
    <?php if(render($content['field_related_article'])): ?>
      <div class="relateA">
        <div class="inner">
          <h3 class="th03">Related contents</h3>
          <ul class="lc02">
                ...
                <dl class="tc02 inner">
                    ...
                    <dd>
                        ...
                        <?php if($writer['taxonomy_term']->field_contact): ?>
                            <a href="mailto:<?php print $writer['taxonomy_term']->field_contact['en'][0]['value'];?>"><?php print $writer['taxonomy_term']->field_contact['en'][0]['value'];?></a>
                        <?php endif;?>
                    </dd>
                </dl>
            <?php endforeach;?>
