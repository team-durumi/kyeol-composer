        ...
        <?php if($main_class === 'fc04') : ?>
            <div class="th02"<?php print $image;?>>
                <div class="inner">
                    ...
                    <ul class="metas">
                      <li><b>Created at</b><span><?php print format_date($created, 'custom', 'Y.m.d');?></span></li>
                    ...
                    <div class="ng03">
                        ...
                        <dl>
                            ...
                            <dd>
                                <input id="share_url" title="post url" type="text" name="share_url" value="<?php print $url;?>"/>
                                <button>copy</button>
                            </dd>
                        </dl>
                    </div>
